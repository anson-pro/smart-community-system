                ...
                <div style="background-color:white;z-index:110;margin:10px;">
                  ...
                  <div style="margin-top:10px;text-align:right">
                    ...
                    <Button
                      type="primary"
                      @click="submitCode"
                      :loading="checkIdentifyCodeLoading"
                    >确定
                    </Button>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      this.userForm.name = 'Anson';
      this.userForm.cellphone = '17601077581';
      this.initPhone = '17601077581';
      this.userForm.company = 'Finupgroup';
      this.userForm.department = '钱站部门';
    },
    cancelInputCodeBox() {
