      ...
      <scroll-bar ref="scrollBar">
        <shrinkable-menu
          ...
          <div slot="top" class="logo-con">
            <span v-show="!shrink">社区管理平台</span>
            <img v-show="shrink" src="../images/logo.png" key="logo"/>
          </div>
        </shrinkable-menu>
      </scroll-bar>
    </div>
...
import scrollBar from '@/views/my-components/scroll-bar/vue-scroller-bars/scroll-bar.vue';
