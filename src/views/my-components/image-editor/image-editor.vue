          ...
          <Col span="6" class="image-editor-con3">
            <Row>
              <Col span="24" class="image-editor-con3-btn-box">
                <input type="file" accept="image/png, image/jpeg, image/gif, image/jpg" @change="handleChange3"
                       id="fileinput3" class="fileinput"/>
                <label class="filelabel filelabel3" for="fileinput3">
                  <Icon type="image"></Icon>&nbsp;选择图片</label>
              </Col>
            </Row>
            <Row class="margin-top-10">
              <Col span="24" class="crop3-btn-box">
                <Tooltip content="开始裁剪" placement="bottom">
                  <Button @click="cropper3.crop()" type="primary">
                    <Icon :size="18" type="checkmark-round"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="取消裁剪" placement="bottom">
                  <Button @click="cropper3.clear()" type="primary">
                    <Icon :size="18" type="close-round"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="不可用" placement="bottom">
                  <Button @click="cropper3.disable()" type="primary">
                    <Icon :size="18" type="android-lock"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="可用" placement="bottom">
                  <Button @click="cropper3.enable()" type="primary">
                    <Icon :size="18" type="android-unlock"></Icon>
                  </Button>
                </Tooltip>
              </Col>
            </Row>
            <Row class="margin-top-10" :gutter="10">
              <Col span="24" class="crop3-btn-box">
                <Tooltip content="放大" placement="bottom">
                  <Button @click="handlezooml" type="primary">
                    <Icon :size="16" type="plus-round"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="缩小" placement="bottom">
                  <Button @click="handlezooms" type="primary">
                    <Icon :size="16" type="minus-round"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="左转" placement="bottom">
                  <Button @click="handlerotatel" type="primary">
                    <Icon :size="16" type="arrow-return-left"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="右转" placement="bottom">
                  <Button @click="handlerotater" type="primary">
                    <Icon :size="16" type="arrow-return-right"></Icon>
                  </Button>
                </Tooltip>
              </Col>
            </Row>
            <Row class="margin-top-10" :gutter="10">
              <Col span="24" class="crop3-btn-box">
                <Tooltip content="左移" placement="bottom">
                  <Button @click="handlemovel" type="primary">
                    <Icon :size="18" type="android-arrow-back"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="右移" placement="bottom">
                  <Button @click="handlemover" type="primary">
                    <Icon :size="18" type="android-arrow-forward"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="上移" placement="bottom">
                  <Button @click="handlemoveu" type="primary">
                    <Icon :size="18" type="android-arrow-up"></Icon>
                  </Button>
                </Tooltip>
                <Tooltip content="下移" placement="bottom">
                  <Button @click="handlemoved" type="primary">
                    <Icon :size="18" type="android-arrow-down"></Icon>
                  </Button>
                </Tooltip>
              </Col>
            </Row>
