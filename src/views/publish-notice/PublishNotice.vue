              ...
              <transition name="fixed-link">
                <FormItem v-show="showLink" label="固定链接">
                  ...
                  <span style="float:right;">
                    <Button
                      :type="editPathButtonType"
                      @click="editArticlePath"
                    >{{ editPathButtonText }}
                    </Button>
                  </span>
                </FormItem>
      ...
      <Col span="6" class="padding-left-10">
        <Card>
          ...
          <p class="margin-top-10">
            ...
            <span
              v-if="publishTimeType === 'immediately'">
              立即发布
            </span>
          ...
          <Card>
            ...
            <transition name="add-new-tag">
              <div v-show="addingNewTag" class="add-new-tag-con">
                ...
                <Col span="5" offset="1">
                  <Button @click="createNewTag" style="text-align:center;" long type="primary">确定</Button>
                </Col>
                <Col span="5" offset="1">
